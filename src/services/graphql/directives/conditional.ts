 ...
 */
function Conditional(
  test: (target?: Object, key?: string | symbol, desc?: PropertyDescriptor) => boolean,
...
function Conditional(test: any, decorator: Function): any {
  ...
  return function (target: Object, key: string | symbol, value: any): any {
    if (isClassDecorator(decorator, arguments)) {
      ...
      const shouldDecorate: boolean = typeof test === 'function' ? test(clazz) : test;
    ...
    if (isParameterDecorator(decorator, arguments)) {
      ...
      const shouldDecorate: boolean = typeof test === 'function' ? test(target, key, index) : test;
      if (shouldDecorate && decorator) {
        decorator(target, key, index);
      }
    }
    if (isPropertyDecorator(decorator, arguments)) {
      const shouldDecorate: boolean = typeof test === 'function' ? test(target, key) : test;
      if (shouldDecorate && decorator) {
    ...
    if (isMethodDecorator(decorator, arguments)) {
      ...
      const shouldDecorate: boolean = typeof test === 'function' ? test(target, key, desc) : test;
      if (shouldDecorate && decorator) {
